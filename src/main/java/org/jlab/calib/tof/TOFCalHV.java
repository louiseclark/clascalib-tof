 ...
 * @author gavalian
 */
public class TOFCalHV implements IDetectorListener,IConstantsTableListener,ActionListener {
...
//        }
    ...
    public static void main(String[] args){
    	...
    	fc.setDialogTitle("Choose input evio file for FTOF HV calibration");
